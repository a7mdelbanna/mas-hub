      ...
      <div className="relative z-10 p-8">
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-purple-200 text-lg">Plan and track asset maintenance activities</p>
          </div>
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-8">
            <div className="text-center py-12">
              <Wrench className="w-16 h-16 text-purple-300 mx-auto mb-4" />
              <h3 className="text-xl font-semibold text-white mb-2">Maintenance Scheduling</h3>
              <p className="text-purple-200 mb-6">Advanced maintenance planning interface</p>
