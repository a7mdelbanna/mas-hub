          ...
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">Project timeline visualization</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-xl border border-white/20 dark:border-gray-700/50 p-8">
            <div className="flex items-center justify-center h-64 text-gray-500 dark:text-gray-400">
              <div className="text-center">
                ...
                <p className="text-sm mt-2">Interactive Gantt chart will be available here</p>
              </div>
            </div>
          </div>
        </div>
