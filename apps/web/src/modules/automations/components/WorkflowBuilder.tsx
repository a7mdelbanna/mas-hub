      ...
      <div className="relative z-10 p-8">
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-purple-200 text-lg">Design and configure automation workflows</p>
          </div>
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-8">
            <div className="text-center py-12">
              ...
              <p className="text-purple-200 mb-6">Drag-and-drop workflow creation interface</p>
